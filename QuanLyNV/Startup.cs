    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                //Neu user thoa man la Admin thi se thoa man chinh sach la AdminDropdown
                //Policy la yêu cầu mà người dùng cần phải thoải mãn để được xác thực quyền truy cập tài nguyên
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Bao loi khi khong tim thay trang
