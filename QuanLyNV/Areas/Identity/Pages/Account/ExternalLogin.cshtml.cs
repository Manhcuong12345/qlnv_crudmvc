...
namespace Album.Areas.Identity.Pages.Account {
    ...
    public class ExternalLoginModel : PageModel {
        ...
        //Hiển thị goi đến url dịch vụ thứ 3 google để chọn email login
        ...
        //Xác nhận thông tin tài khoản email và lưu vào hệ thống với mail đăng nhập từ google đó
